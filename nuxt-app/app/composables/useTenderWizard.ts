...
import type { TenderCriterion, TenderFormData, TenderPriceBlock, TenderVendor } from '../types/tender-wizard'
...
function createInitialTenderData(): TenderFormData {
  return {
    name: '',
...
export function useTenderWizard() {
  const activeStep = ref(0)

  const tenderData = reactive<TenderFormData>(createInitialTenderData())
